...
class ApzQrScannerIcons {
  ...
  const ApzQrScannerIcons({
    this.flashOnIcon = const Icon(
      Icons.flash_on,
      semanticLabel: "flash On Icon",
    ),
    this.flashOffIcon = const Icon(
      Icons.flash_off,
      semanticLabel: "flash Off Icon",
    ),
    this.flashAlwaysIcon = const Icon(
      Icons.flash_on,
      semanticLabel: "flashAlwaysIcon",
    ),
    this.flashAutoIcon = const Icon(
      Icons.flash_auto,
      semanticLabel: "flash Auto Icon",
    ),
    this.galleryIcon = const Icon(
      Icons.photo_library,
      semanticLabel: "Gallery Icon",
    ),
    this.toggleCameraIcon = const Icon(
      Icons.cameraswitch,
      semanticLabel: "toggle Camera Icon",
    ),
  });

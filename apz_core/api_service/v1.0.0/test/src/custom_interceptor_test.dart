...
void main() {
  ...
  group("EncryptionInterceptor.onRequest", () {
    ...
    test("should set encrypted payload and serverToken", () async {
      final RequestOptions options = RequestOptions(
        path: "/test",
        method: "POST",
        data: <String, String>{"foo": "bar"},
      ...
      expect(data["serverToken"], encryptedKey);
      expect(handler.calledReject, isFalse);
    });
  });
  ...
  group("EncryptionInterceptor.onResponse", () {
    ...
    test("should reject if serverToken missing", () async {
      final RequestOptions options = RequestOptions(
        path: "/test",
        method: "POST",
        extra: <String, dynamic>{},
      ...
      expect((handler.passedException!).error, contains("serverToken missing"));
    });

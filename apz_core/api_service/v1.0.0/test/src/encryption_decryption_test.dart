...
void main() {
  ...
  group("EncryptionDecryption.encryptRequest", () {
    ...
    test(
      "encrypts request data and includes serverToken when key not set",
      () async {
        final RequestOptions options = RequestOptions(
          path: "/test",
          method: "POST",
        ...
        expect(payload.containsKey("serverToken"), isTrue);
        expect(payload["serverToken"], equals("encrypted_key_value"));
      },
    );

    test(
      """encrypts request data without serverToken when symmetric key already set""",
      () async {
        ...
        final Response<dynamic> response = Response<dynamic>(
          ...
          data: <String, dynamic>{
            ...
            "serverToken": "encryptedServerToken",
          },
        );
        ...
        // no serverToken should be added
        ...
        expect(payload.containsKey("serverToken"), isFalse);
        expect(payload.containsKey("body"), isTrue);
      },
    );
  });
  ...
  group("EncryptionDecryption.decryptResponse", () {
    test("throws when serverToken missing or symmetric key not set", () async {
      final RequestOptions options = RequestOptions(
        path: "/test",
        method: "POST",
        extra: <String, dynamic>{},

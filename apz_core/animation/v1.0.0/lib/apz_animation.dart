...
class ApzAnimation {
      ...
      switch (paymentStatus) {
        ...
        case PaymentStatus.success:
          statusGif = Image.asset(
            ...
            fit: BoxFit.cover,
            semanticLabel: "success gif image",
          );
        case PaymentStatus.failure:
          statusGif = Image.asset(
            failureGifPath ?? "packages/apz_animation/gif/failed.gif",
            fit: BoxFit.cover,
            semanticLabel: "failure gif image",
          );
      }
    }
  ...
  Widget walkthroughCarousel({required final WalkthroughModel carouselData}) =>
      Carousel(
  ...
  Widget bannerCarousel({required final BannerModel carouselData}) => Carousel(

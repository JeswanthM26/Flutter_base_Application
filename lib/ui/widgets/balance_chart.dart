...
//                       color: AppColors.dashboardBalanceTrendLineGradientStart(
//                           context),
//                       barWidth: 2,
...
//                                 .dashboardBalanceTrendLineGradientStart(context),
//                           );
//                         },
//                       ),
//                     ),
...
// import 'package:Retail_Application/models/dashboard/change_balance.dart';
// import 'package:Retail_Application/themes/apz_app_themes.dart';
// import 'package:Retail_Application/ui/components/apz_text.dart';
// import 'package:fl_chart/fl_chart.dart';
// import 'package:flutter/material.dart';
...
// class BalanceTrendChart extends StatefulWidget {
//   final BalanceTrendModel? trendData;
//   const BalanceTrendChart({super.key, this.trendData});
//   @override
//   State<BalanceTrendChart> createState() => _BalanceTrendChartState();
// }
...
//     if (widget.trendData?.accountNo != oldWidget.trendData?.accountNo) {
//       _processData();
//     }
//   }
...
//     allData = widget.trendData!.trend.map((e) {
//       return {
//         "date": e["date"],
//         "balance":
...
//                           displayPage == 0
//                               ? "Last 4 weeks"
//                               : uniqueMonthStarts.isEmpty
//                                   ? ""
//                                   : _monthName(
//                                         uniqueMonthStarts[
//                                                 uniqueMonthStarts.length -
//                                                     displayPage]
//                                             .month,
//                                       ) +
//                                       " " +
...
//                       getTooltipItems: (touchedSpots) {
//                         return touchedSpots.map((spot) {
//                            if (spot.x.toInt() >= _data.length) return null;
...
//                             yAxisLabels.isNotEmpty ? yAxisLabels.first : 1000,
//                         getTitlesWidget: (value, meta) {
//                            if (yAxisLabels.isEmpty) return const SizedBox.shrink();
//                           bool show = yAxisLabels.any((element) =>
//                               (element - value).abs() <
//                               yAxisLabels.first * 0.1);
//                           return show
...
class BalanceTrendChart extends StatefulWidget {
  final BalanceTrendModel? trendData;
  const BalanceTrendChart({super.key, this.trendData, required AccountModel accountData});
  @override
  State<BalanceTrendChart> createState() => _BalanceTrendChartState();
}

    ...
    _selectedCameraIndex =
        _cameras?.indexWhere(
          (final CameraDescription c) =>
              c.lensDirection == widget._params.lensDirection,
        ) ??
        -1;
                      ...
                      child: DecoratedBox(
                        ...
                        child: IconButton(
                          ...
                          icon: const Icon(
                            Icons.close,
                            color: Colors.white,
                            semanticLabel: "Cancel camera button",
                          ),
                          onPressed: () {
                            Navigator.of(
                              context,
                                ...
                                DecoratedBox(
                                  ...
                                  child: IconButton(
                                    ...
                                    icon: const Icon(
                                      Icons.switch_camera,
                                      color: Colors.white,
                                      semanticLabel: "switch Camera Button",
                                    ),
